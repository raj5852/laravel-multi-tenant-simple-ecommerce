    ...
    <div class="container-fluid">
        <div class="row bg-secondary py-2 px-xl-5">
            ...
            <div class="col-lg-6 text-center text-lg-right">
                <div class="d-inline-flex align-items-center">
                    @guest
                        <a class="text-dark px-2" href="/user-register">
                            Register
                        </a>
                        <a class="text-dark px-2" href="/user-login">
                            Login
                        </a>
                    @else
                        <p>Hello, welcome </p>
                        <p class="ml-1"><a href="/logout"> Logout</a></p>
                    @endguest
        ...
        <div class="row align-items-center py-3 px-xl-5">
            ...
            <div class="col-lg-6 col-6 text-left">
                <form action="">
                    <div class="input-group">
                        <form action="/">
                            <input type="text" name="search" value="{{ request('search') }}" class="form-control" placeholder="Search for products">
            ...
            <div class="col-lg-3 col-6 text-right">
                ...
                <a href="" class="btn border">
                    ...
                    <span class="badge">{{ total_add_to_cart_prodcut() }}</span>
                </a>
            </div>
        </div>
    </div>
